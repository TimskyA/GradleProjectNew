...
public class Buttons {//нажатие на кнопку
    public static void common(String button) {
        switch (button) {
            ...
            case "Редактировать":                                                                                       $("[id*=dijit_form_Button_0]").click();break;
            ...
            case "Создать шаблон":                                                                                      $("[id=dijit_form_Button_4_label]").click();break;
            ...
            case "Стрелка вниз (расчеты)":                                                                              $("[class=arrow]").click();break;
            case "Экспортировать список карточек в Excel":                                                              $("[id=dijit_form_Button_3]").click();break;
